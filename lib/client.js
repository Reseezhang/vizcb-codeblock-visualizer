// vizcb-codeblock-visualizer - browser half (v2.2 / 1.5.0).
...
// v1.5.0: retryable read-turn failures are no longer cached (retry actually
// refetches); mermaid dark mode follows config/theme detection; card canvas
// background comes from cfg.canvasBg; lightbox validates SVG like the card.
